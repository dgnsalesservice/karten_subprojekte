...
DB_PARAMS_dev = {
    "host": "pgeuwgispr004.postgres.database.azure.com",         # z. B. 'localhost' oder die IP des DB-Servers
    "port": 5432,                # Standardport PostgreSQL
    "database": "dgn_gis",     # Name deiner Datenbank
    "user": "dgn_data_sales",          # DB-Benutzername
    "password": "eB*77zeW8hXzVH9ci34*"    # Passwort (Achtung bei Teamsicherheit!)
}
